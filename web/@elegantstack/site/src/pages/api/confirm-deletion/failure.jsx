  ...
  return (
    <Layout theme={theme} {...props}>
      ...
      <ContentContainer variant='cards.paper-lg' sx={{ textAlign: 'center' }}>
          <h2>Error</h2>
          <p>An unexpected error happened while trying to perform the requested operation. Please try again or contact support if the error persists.</p>
        </ContentContainer>    
      </Container>
      <Divider space='5' />
...
export const query = graphql`
  query iluramaAPIFailureBlockContent {
